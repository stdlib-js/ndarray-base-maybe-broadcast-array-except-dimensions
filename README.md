...
```javascript
maybeBroadcastArrayExceptDimensions = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-maybe-broadcast-array-except-dimensions@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var maybeBroadcastArrayExceptDimensions = require( 'path/to/vendor/umd/ndarray-base-maybe-broadcast-array-except-dimensions/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-maybe-broadcast-array-except-dimensions@umd/browser.js"></script>
```
...
(function () {
    window.maybeBroadcastArrayExceptDimensions;
})();
</script>
```
