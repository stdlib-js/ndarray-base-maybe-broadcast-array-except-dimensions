...
```javascript
import maybeBroadcastArrayExceptDimensions from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-maybe-broadcast-array-except-dimensions@esm/index.mjs';
```
